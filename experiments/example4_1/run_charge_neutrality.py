...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Charge-neutrality diagnostic for Example 4.1")
...
def run(args: argparse.Namespace) -> dict[str, float]:
    ...
    os.environ["SO_RANN_RUN"] = f"example4_1/charge_seed_{args.seed}"
    set_seed(args.seed)
    diagnostics = main(
        r_c1=2.0,
        r_c2=2.0,
    ...
    summary = save_charge_diagnostics(diagnostics, "example4_1", z1=1.0, z2=-1.0)
    print(summary)
    return summary
